                ...
                {  function (name_style) {
                  return (
                    <h1
                      ...
                      className={s.big_name}>CHASE G ROCK</h1>
                  )
                }}
              </Motion>
              : <h1 style={{ opacity: 0 }} className={s.big_name}>CHASE G ROCK</h1>
            }
                ...
                {  function (name_style) {
                  return (
                    <h2
                      ...
                      >Exercise Science, M.S.  Neuroscience, B.S.</h2>
                  )
                }}
              </Motion>
        ...
        <Element name="bio">
          ...
          <div className={s.bio_wrapper}>
            <div id="bio" className={s.wrapper}>
              ...
              <a className={s.cv_button} href="/CRock_CV_08202018.pdf"><h4>Curriculum Vitae</h4></a>
            </div>
          </div>
        </Element>
